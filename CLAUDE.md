...
| Ship | `/ship [type]` | Generate deliverables (prd, presentation, report, lean-canvas, benchmark, audit, strategy) |
...
| `03_Outputs/LEAN_CANVAS.html` | Lean Canvas (business model) | Yes (via `/ship`) |
...
│   ├── ship/SKILL.md          /ship — generate deliverables (incl. lean-canvas)
